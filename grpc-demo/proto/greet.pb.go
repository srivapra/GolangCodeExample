...
func (x *MessagesLists) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessagesLists) ProtoMessage() {}

func (x *MessagesLists) ProtoReflect() protoreflect.Message {
	mi := &file_proto_greet_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessagesLists.ProtoReflect.Descriptor instead.
func (*MessagesLists) Descriptor() ([]byte, []int) {
	return file_proto_greet_proto_rawDescGZIP(), []int{4}
}

func (x *MessagesLists) GetMessage() []string {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x22, 0x21, 0x0a, 0x09, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x12,
	0x14, 0x0a, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05,
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x29, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x73, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x32, 0xde, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x56, 0x0a, 0x17, 0x53, 0x61, 0x79, 0x48,
	...
	0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x28, 0x01,
...
var file_proto_greet_proto_goTypes = []interface{}{
	...
	(*MessagesLists)(nil), // 4: greet_service.MessagesLists
}
var file_proto_greet_proto_depIdxs = []int32{
	...
	4, // 6: greet_service.GreetService.SayHelloClientStreaming:output_type -> greet_service.MessagesLists
