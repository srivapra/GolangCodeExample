...
type GreetService_SayHelloClientStreamingClient interface {
	...
	CloseAndRecv() (*MessagesLists, error)
	grpc.ClientStream
}
...
func (x *greetServiceSayHelloClientStreamingClient) CloseAndRecv() (*MessagesLists, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(MessagesLists)
...
type GreetService_SayHelloClientStreamingServer interface {
	SendAndClose(*MessagesLists) error
...
func (x *greetServiceSayHelloClientStreamingServer) SendAndClose(m *MessagesLists) error {
	return x.ServerStream.SendMsg(m)
}
